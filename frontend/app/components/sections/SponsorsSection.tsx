...
const INSTITUTIONAL_PARTNERS: Partner[] = [
  { name: "VIT Bhopal University", logo: "/Collegelogo.png", className: "max-h-14 sm:max-h-16 md:max-h-20 max-w-[140px] sm:max-w-[180px] object-contain" },
  { name: "Institution's Innovation Council", logo: "/IIC Logo.png", className: "max-h-14 sm:max-h-16 md:max-h-20 max-w-[140px] sm:max-w-[180px] object-contain" },
  { name: "Student Welfare Office", logo: "/SW Office Logo Light.png", className: "max-h-14 sm:max-h-16 md:max-h-20 max-w-[150px] sm:max-w-[200px] object-contain" },
  { name: "Data Science Club", logo: "/DSClogo.png", className: "max-h-14 sm:max-h-16 md:max-h-20 max-w-[140px] sm:max-w-[180px] object-contain" },
];

const SPONSORS: Sponsor[] = [
  { name: "Sheryians Coding School", category: "title", logo: "/sponsors/Sheryians logo white.png" },
  { name: "Too Yumm!", category: "title", logo: "/sponsors/tooyumm.png" },
  { name: "Kavita Sales", category: "title", logo: "/sponsors/kavitasales.png" },
];
